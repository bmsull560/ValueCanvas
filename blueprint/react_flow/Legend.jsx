...
function Legend() {
  return (
    <div style={{ padding: '8px', backgroundColor: '#fafafa', border: '1px solid #e0e0e0', borderRadius: '4px', fontSize: '12px' }}>
      <strong>Legend</strong>
      {legendItems.map((item) => (
        <div key={item.label} style={{ display: 'flex', alignItems: 'center', marginTop: '4px' }}>
