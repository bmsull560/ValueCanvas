...
- **Setup Guide**: `LOCAL_SETUP_GUIDE.md` (detailed)
- **LLM-MARL**: `LLM_MARL_COMPLETE.md`
- **Generative UI**: `GENERATIVE_UI_COMPLETE.md`
- **SOF Guide**: `SOF_IMPLEMENTATION_GUIDE.md`
...
- Check `LOCAL_SETUP_GUIDE.md` for detailed help
