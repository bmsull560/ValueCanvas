...
CREATE INDEX idx_secret_audit_logs_tenant_id ON secret_audit_logs(tenant_id);
...
CREATE INDEX idx_secret_audit_logs_result ON secret_audit_logs(result);
CREATE INDEX idx_secret_audit_logs_tenant_timestamp ON secret_audit_logs(tenant_id, timestamp DESC);

-- Create composite index for common query patterns
CREATE INDEX idx_secret_audit_logs_tenant_action_timestamp 
