...
CREATE INDEX IF NOT EXISTS idx_agent_predictions_agent_type ON agent_predictions(agent_type);
CREATE INDEX IF NOT EXISTS idx_agent_predictions_session_id ON agent_predictions(session_id);
CREATE INDEX IF NOT EXISTS idx_agent_predictions_created_at ON agent_predictions(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_agent_predictions_confidence ON agent_predictions(confidence_level, confidence_score);
CREATE INDEX IF NOT EXISTS idx_agent_predictions_hallucination ON agent_predictions(hallucination_detected) WHERE hallucination_detected = TRUE;
CREATE INDEX IF NOT EXISTS idx_agent_predictions_input_hash ON agent_predictions(input_hash);

-- Composite index for accuracy analysis
CREATE INDEX IF NOT EXISTS idx_agent_predictions_accuracy ON agent_predictions(agent_type, created_at DESC) 
...
CREATE INDEX IF NOT EXISTS idx_confidence_violations_agent_type ON confidence_violations(agent_type);
CREATE INDEX IF NOT EXISTS idx_confidence_violations_created_at ON confidence_violations(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_agent_accuracy_agent_type ON agent_accuracy_metrics(agent_type);
CREATE INDEX IF NOT EXISTS idx_agent_accuracy_recorded_at ON agent_accuracy_metrics(recorded_at DESC);
CREATE INDEX IF NOT EXISTS idx_agent_accuracy_org ON agent_accuracy_metrics(organization_id) WHERE organization_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_agent_retraining_status ON agent_retraining_queue(status);
CREATE INDEX IF NOT EXISTS idx_agent_retraining_scheduled ON agent_retraining_queue(scheduled_at);
CREATE INDEX IF NOT EXISTS idx_agent_retraining_agent_type ON agent_retraining_queue(agent_type);
